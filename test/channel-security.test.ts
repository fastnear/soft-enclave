...
describe('Secure Channel - Origin Validation', () => {
  it('MUST reject messages from wrong origin', () => {
    ...
    const expectedOrigin = 'http://localhost:8091';
  ...
  it('MUST NOT be fooled by origin substring attacks', () => {
    ...
    const attackOrigins = [
      'http://localhost:8091.evil.com',
      'http://evil-localhost:8091.com',
      'http://localhost:8091/',  // Trailing slash
      'http://localhost:8091#',  // Fragment
      'http://user@localhost:8091' // Userinfo
    ];
...
describe('Secure Channel - Defense in Depth', () => {
  it('demonstrates 5 independent security layers', () => {
    ...
    const originValid = 'http://localhost:8091' === 'http://localhost:8091';
